...
function HeaderVideo() {
  ...
  const fetchVideo = async () => {
    try {
      setLoading(true);
      const res = await axios.get("https://backend-wine-chi-49.vercel.app/header-video");
      setVideo(res.data);
  ...
  const handleSubmit = async () => {
    ...
    try {
      if (video) {
        await axios.put(`https://backend-wine-chi-49.vercel.app/header-video/${video._id}`, { iframe });
        toast.success("Video updated successfully!");
        refetch()
      } else {
        await axios.post("https://backend-wine-chi-49.vercel.app/header-video", { iframe });
  ...
  const handleDelete = async () => {
    try {
      await axios.delete(`https://backend-wine-chi-49.vercel.app/header-video/${video._id}`);
